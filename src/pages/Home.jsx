  ...
  return (
    <>
        ...
        <div className="relative z-20 container mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-5">
              <a
                href="#contact"
                className="group relative inline-flex items-center justify-center px-8 py-4 rounded-2xl font-extrabold text-lg bg-gradient-to-r from-yellow-400 to-yellow-300 text-black shadow-[0_20px_40px_rgba(250,204,21,0.45)] transition-all duration-300 hover:scale-105 hover:shadow-[0_30px_60px_rgba(250,204,21,0.6)]"
              >
              ...
              <a
                href="#services"
                className="group relative inline-flex items-center justify-center px-8 py-4 rounded-2xl font-bold text-lg text-white border border-white/30 backdrop-blur-md bg-white/5 transition-all duration-300 hover:bg-white hover:text-black hover:scale-105"
              >
                <span className="relative z-10">Explore Services</span>
                <span className="absolute inset-0 rounded-2xl border border-white/20 group-hover:border-yellow-400/60 transition"></span>
              </a>
            </div>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg shadow-green-400/50 hover:shadow-2xl hover:shadow-green-500/70 transform hover:scale-110 transition-all duration-300 ring-2 ring-green-400/30 hover:ring-green-500/50"
      >
        <FaWhatsapp size={28} />
      </a>
    </>
